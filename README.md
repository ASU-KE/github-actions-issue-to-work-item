...
1. Add a workflow file which responds to issue events, generates an Entra ID token, and syncs the issue
   ...
   - `ado_parent_id`: Used to set the parent work item id for the work item created. This is useful when you want to create a child work item for a parent work item.
    ...
    steps:
      ...
      - uses: danhellem/github-actions-issue-to-work-item@master
        env:
          ...
          ado_parent_id: "optional_parent_work_item_id"
          ado_wit: "User Story"
          ado_new_state: "New"
